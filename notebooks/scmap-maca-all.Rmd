...
When using all MACA data, most cells in the mixture cluster got assigned as mammary basal cells or hematopoetic stem cells. When only using the Fat data, most cells got assigned as epithelial cell.
