...
Where is cluster 304 in the MACA data?

```{r}
DimPlot(seurat_obj, reduction.use='tsne', cells.highlight = seurat_obj@cell.names[seurat_obj@meta.data$res.40 == 304], cols.use = 'grey', cols.highlight='blue')
```
