...
```{r fig5, fig.height = 30, fig.width = 10, fig.align = "center"}
VlnPlot(all10x, features.plot=as.vector(markers[markers$cluster == 'Visce.brown',][1:20,'gene']), group.by='sample_name', point.size.use=-1, nCol=2, x.lab.rot=T, size.x.use=10)
```
